...
**From the marketplace:** open Typora's settings, go to **Plugin Marketplace**,
search for **Favorites**, and install it. Then go to **Installed Plugins** and
tick **Favorites** to enable it.
